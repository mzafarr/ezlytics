...
{{brandName}} does not store full IP addresses in analytics tables. Incoming requests are used to derive coarse country-level data only, and any metadata values are sanitized to strip scripts/HTML.
